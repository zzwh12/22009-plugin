...
async function combination (e, data, but) {
  ...
  for (let p of data) {
    ...
    const button2 = [
      { label: '拉群', link: 'https://qun.qq.com/qunpro/robot/qunshare?robot_uin=3889011906&robot_appid=102089849' },
      { label: '联系我', link: 'https://qm.qq.com/q/J2kuhP9z6U' },
      { label: '赞助', link: 'https://afdian.net/a/zouzwh' },
